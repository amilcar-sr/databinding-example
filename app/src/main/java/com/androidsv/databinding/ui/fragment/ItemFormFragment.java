...
public class ItemFormFragment extends Fragment implements ValueEventListener, View.OnClickListener {

    public final static String TAG = ItemFormFragment.class.getName();
    ...
    public static ItemFormFragment getInstance(String itemId) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentItemFormBinding itemFormBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_item_form, container, false);

        mViewModel = new ItemViewModel(mItem);
        itemFormBinding.setItem(mViewModel);

        itemFormBinding.saveFab.setOnClickListener(this);
